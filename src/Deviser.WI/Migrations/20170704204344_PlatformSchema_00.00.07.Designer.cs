...
namespace Deviser.WI.Migrations
{
    ...
    partial class PlatformSchema_000007
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Deviser.Core.Data.Entities.ContentControlProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ContentControlProperty");
                });
            ...
            modelBuilder.Entity("Deviser.Core.Data.Entities.FieldType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Deviser.Core.Data.Entities.Validator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Deviser.Core.Data.Entities.ContentControl", b =>
                {
                    b.HasOne("Deviser.Core.Data.Entities.FieldType", "FieldType")
            ...
            modelBuilder.Entity("Deviser.Core.Data.Entities.ContentControlProperty", b =>
                {
                    b.HasOne("Deviser.Core.Data.Entities.ContentControl", "ContentControl")
                        .WithMany("ContentControlProperties")
            ...
            modelBuilder.Entity("Deviser.Core.Data.Entities.ContentTypeControl", b =>
                {
                    ...
                    b.HasOne("Deviser.Core.Data.Entities.Validator", "Validator")
                        .WithMany("ContentTypeControls")
